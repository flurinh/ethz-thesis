...
% Languages
\usepackage[main=english,ngerman,french,italian]{babel}
...
\usepackage{floatrow}
\DeclareFloatFont{tablefont}{\footnotesize}
...
% Override classicthesis Palatino with Times New Roman (TeX Gyre Termes)
\usepackage{tgtermes}
\usepackage{mathptmx}

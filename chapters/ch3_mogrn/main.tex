...
\begin{figure}[H]
  ...
  \caption[Key MOGRN positions on bacteriorhodopsin]{%
    Bacteriorhodopsin (PDB: 1C3W) with key MOGRN positions highlighted. The Schiff base lysine K216 (7.50), counterion D85 (3.45), D212 (3.46), and TM3 residues T89 (7.49), W86 (3.53), and D96 (3.56) are shown as sticks. Retinal in rust.}\worktodo{Fact-check: the figure labels D212 as 3.46 and T89 as 7.49, but D212 is on helix~7 and T89 is on helix~3---verify whether the figure labels or the helix assignments need correction, and regenerate the figure if needed.}

...
The work summarized here is presented in \hyperref[ch:mogrn-manuscript]{the manuscript} ``A Generic Residue-Numbering System for Microbial Rhodopsins''\cite{hidber2026mogrn}, of which I am a co-first author.
...
We developed MOGRN (Microbial Opsin Generic Residue Numbering), anchored to the one feature all microbial rhodopsins share: the retinal-binding pocket. The system is defined by structural alignment of 129 structures spanning all major functional classes, producing a curated reference table, and was applied to approximately 40,000 sequences. Examples of this generic residue numbering are shown below; the full methodology, results, and discussion are available in \hyperref[ch:mogrn-manuscript]{the manuscript}.

...
ProtOS-MCP completes the stack by removing the programming requirement. The same processors that powered the Opsin Atlas are accessible through natural language. A multi-step spectral engineering workflow---sequence registration, GRN annotation, binding pocket comparison, mutant library creation, LAMBDA screening---ran through four conversational turns, 20 tool calls, no code written.

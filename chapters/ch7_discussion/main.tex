...
Three gaps motivated this work. Microbial rhodopsins lacked standardized positional annotation. No method predicted spectral properties across the type~I / type~II divide. And existing tools did not compose into workflows linking sequences, structures, and functional properties while maintaining consistent identity.
...
ProtOS made this feasible at scale. Routing 40,000 sequences through the full analysis pipeline requires managing data across formats and processors without manual intervention. The Opsin Atlas exists because ProtOS could execute this pipeline for every sequence without custom scripting per step.

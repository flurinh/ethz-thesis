...
\begin{figure}[tb]
  \centering
  % \includegraphics[width=\textwidth]{\dir/figure_5_4.pdf}
...
We selected the top candidate by balancing theozyme RMSD (\SI{2.44}{\angstrom} all-atom, \SI{0.51}{\angstrom} C$\alpha$-only, rank~6 of 307) against the highest global pLDDT in the top~10 (91.7). The overall backbone RMSD to the parent rhodopsin is \SI{0.84}{\angstrom}, confirming that the fold is preserved.\worktodo{Fact-check: verify pLDDT values (91.7, 94.9, 85.6, 72.1) and RMSD values (\SI{0.84}{\angstrom}, \SI{2.44}{\angstrom}) from the actual Boltz2 output files.} The pLDDT breakdown shows high confidence in the locked TM core (94.9 mean) and good confidence in the designed loops (85.6 mean), with the theozyme residues at 72.1---lower, as expected for residues at a designed interface.
...
\begin{figure}[tb]
  \centering
  % \includegraphics[width=\textwidth]{\dir/figure_5_6.pdf}

...
\chapterabstract{This chapter, on the application of ProtOS, is meant as a showcase of its capabilities---the protein design process demonstrated here is computational and analytically sound. Experimentally feasible? I will answer that at the end. The validation remains outside the scope of my own work.}

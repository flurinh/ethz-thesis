...
\addchap{Manuscript: A Generic Residue-Numbering System for Microbial Rhodopsins}
\label{ch:mogrn-manuscript}
\label{app:a_generic_residue_numbering_system}
\manualmark
\markboth{\spacedlowsmallcaps{Manuscript: MO Numbering System}}{\spacedlowsmallcaps{Manuscript: MO Numbering System}}
...
%-------------------------------------------------------
% Figures — title and mark set on the first figure page
%-------------------------------------------------------

\includepdf[pages=1,width=\textwidth,pagecommand={\pdfbookmark[2]{Figures}{ms-grn-figures}\markboth{\spacedlowsmallcaps{Figures}}{\spacedlowsmallcaps{Figures}}}]{figures_cropped.pdf}
...
\includepdf[pages=7,width=\textwidth,pagecommand={\pdfbookmark[2]{Supplementary Figures}{ms-grn-suppfigures}\markboth{\spacedlowsmallcaps{Supplementary Figures}}{\spacedlowsmallcaps{Supplementary Figures}}}]{figures_cropped.pdf}
